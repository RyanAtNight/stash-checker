...
// @connect localhost
// @connect *
// @downloadURL https://github.com/RyanAtNight/stash-checker/releases/latest/download/index.prod.user.js
...
// @license MIT
// @run-at document-end
// @source https://github.com/RyanAtNight/stash-checker
// @updateURL https://github.com/RyanAtNight/stash-checker/releases/latest/download/index.prod.meta.js
// ==/UserScript==
      ...
      __webpack_require__.a(module, (async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          function getDataFields(target) {
            ...
            if (!_settings_providers__WEBPACK_IMPORTED_MODULE_7__.$k.get(_settings_providers__WEBPACK_IMPORTED_MODULE_7__.vw.showTags)) supported.delete(_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7.Tags);
            if (!_settings_providers__WEBPACK_IMPORTED_MODULE_7__.$k.get(_settings_providers__WEBPACK_IMPORTED_MODULE_7__.vw.showFiles)) supported.delete(_dataTypes__WEBPACK_IMPORTED_MODULE_3__.J7.Files);
          ...
          function escapeString(value, method) {
            ...
            switch (method) {
             ...
             case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.IT.Post:
          ...
          async function queryStash(queryString, onload, target, type, customFilter, stashIdEndpoint) {
            ...
            let query;
            let access = d => d;
            let method = (0, _settings_providers__WEBPACK_IMPORTED_MODULE_7__.gW)();
            switch (type) {
            ...
            switch (target) {
             ...
             case _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We.Group:
            ...
            _settings_endpoints__WEBPACK_IMPORTED_MODULE_1__.I.forEach((endpoint => {
              (0, _request__WEBPACK_IMPORTED_MODULE_4__.E)(endpoint, query, method, true).then((data => onload(target, type, endpoint, access(data))));
            }));
          }
          async function checkElement(target, element, customFilter, display, {displaySelector = e => e, urlSelector = e => e.closest("a")?.href, codeSelector, stashIdSelector, stashIdEndpoint = `https://${window.location.host}/graphql`, nameSelector = _utils__WEBPACK_IMPORTED_MODULE_2__.ou, titleSelector = _utils__WEBPACK_IMPORTED_MODULE_2__.ou}) {
            ...
            if ([ _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We.Performer, _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We.Group, _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We.Studio, _dataTypes__WEBPACK_IMPORTED_MODULE_3__.We.Tag ].includes(target) && nameSelector) {
          ...
          function check(target, elementSelector, {observe = false, ...checkConfig} = {}) {
            if (observe) (0, _observer__WEBPACK_IMPORTED_MODULE_5__.C)(elementSelector, (element => checkWithCustomRules(target, element, checkConfig)));
    ...
    494(module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.a(module, (async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          var _util_jobQueue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(207);
          ...
          _settings_providers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_async_dependencies_result__[0];
          ...
          async function addQuery(endpoint, query, method) {
            return new Promise(((resolve, reject) => {
              ...
              switch (method) {
               ...
               case _dataTypes__WEBPACK_IMPORTED_MODULE_0__.IT.Post:
              ...
              const batchSize = _settings_providers__WEBPACK_IMPORTED_MODULE_3__.Es.get(_settings_providers__WEBPACK_IMPORTED_MODULE_3__.vw.batchSize);
          ...
          async function sendQuery(endpoint, query, method) {
          ...
          function statusMessage(status, statusText) {
            if (statusText && statusText.trim() !== "") return `${status}: ${statusText}`; else return `${status}: ${_utils__WEBPACK_IMPORTED_MODULE_1__.iy.get(status)}`;
          }
          __webpack_async_result__();
        } catch (e) {
          __webpack_async_result__(e);
      ...
      __webpack_require__.a(module, (async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          (function(OptionKey) {
            ...
            OptionKey["queryMethod"] = "queryMethod";
            OptionKey["dateFormat"] = "dateFormat";
          })(OptionKey || (OptionKey = {}));
          ...
          const defaultStringOptions = new Map([ [ OptionKey.checkMark, "✓" ], [ OptionKey.crossMark, "✗" ], [ OptionKey.warningMark, "!" ], [ OptionKey.theme, _dataTypes__WEBPACK_IMPORTED_MODULE_1__.Sx.Device ], [ OptionKey.queryMethod, _dataTypes__WEBPACK_IMPORTED_MODULE_1__.IT.Get ], [ OptionKey.dateFormat, _dataTypes__WEBPACK_IMPORTED_MODULE_1__.ow.Local ] ]);
          ...
          function getEnumOptionMethod() {
            let methodString = stringOptions.get(OptionKey.queryMethod);
            switch (methodString) {
             case _dataTypes__WEBPACK_IMPORTED_MODULE_1__.IT.Get:
             case _dataTypes__WEBPACK_IMPORTED_MODULE_1__.IT.Post:
              return methodString;
      ...
      __webpack_require__.a(module, (async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          ...
          async function runStashChecker() {
            ...
            let directChildTextNode = e => Array.from(e?.childNodes ?? []).find((n => n.isText() && !n.textContent?.isBlank()));
            switch (window.location.host) {
             ...
             case "duga.jp":
              {
                if (window.location.pathname.startsWith("/ppv/") || window.location.pathname.startsWith("/month/")) {
                  (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, "#contentsname.title", {
                    urlSelector: _ => currentSite().replace("/month/", "/ppv/"),
                    codeSelector: _ => document.querySelector("[itemprop='mpn']")?.textContent
                  });
                  (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Studio, ".maintitle.multiple", {
                    urlSelector: currentSite
                  });
                } else if (window.location.pathname.startsWith("/search/=/performerid=")) (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Performer, ".performerdetail .name", {
                  urlSelector: currentSite
                });
                let displaySelector = e => directChildTextNode(e.querySelector(".title"));
                let titleSelector = e => directChildTextNode(e)?.textContent;
                let sceneSelector = ".contentslist > a[href*='/ppv/'], .contentslist > a[href*='/month/'], .monthlylist > a[href*='/month/'], .sidemenu > a[href*='/ppv/']";
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, sceneSelector, {
                  observe: true,
                  urlSelector: e => e.closest("a")?.href?.replace("/month/", "/ppv/"),
                  displaySelector,
                  titleSelector
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Performer, ".sidemenu.actress > a[href*='/search/=/performerid=']", {
                  observe: true,
                  displaySelector,
                  nameSelector: titleSelector
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, ".serieslist > a[href*='/search/=/seriesid=']", {
                  observe: true,
                  displaySelector,
                  nameSelector: titleSelector
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Studio, ".newlabel a[href*='/ppv/']", {
                  observe: true,
             ...
             case "theporndb.net":
              {
                ...
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "div.flex.justify-between > h2", {
                  observe: true,
                ...
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "a[href^='https://theporndb.net/movies/']", {
                  observe: true
                });
                break;
              }
             ...
             case "www.avbase.net":
              ...
              (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "a[href*='/series/']:not([href*='page='])", {
                observe: true
              });
              ...
              if (/series\//.test(window.location.pathname)) (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "h1:first-child", {
                observe: true
              });
              break;
             ...
             case "www.data18.com":
              {
                ...
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "a[href^='https://www.data18.com/movies/']:not([href*='#']):not([href$='/movies/series']):not([href$='/movies/showcases'])", {
                  observe: true,
             ...
             case "www.eternaldesire.com":
              {
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, "a[href*='/movie']:not(.tab):not(:has(.update-stream-card))", {
                  observe: true
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Gallery, "a[href*='/gallery/']:not(.page-button):not(:has(.update-stream-card))", {
                  observe: true
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Performer, "a[href*='/model/']:not([href*='/movie']):not([href*='/gallery/']):not(.page-button):not(.tab):not(:has(.update-stream-card))", {
                  observe: true
                });
                const updateCardSelector = e => e.querySelector(".card-information-title");
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, "a[href*='/movie']:not(.tab):has(.update-stream-card)", {
                  observe: true,
                  titleSelector: e => updateCardSelector(e)?.textContent?.substringAfter(" - "),
                  displaySelector: updateCardSelector
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Gallery, "a[href*='/gallery/']:not(.page-button):has(.update-stream-card)", {
                  observe: true,
                  titleSelector: e => updateCardSelector(e)?.textContent?.substringAfter(" - "),
                  displaySelector: updateCardSelector
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Performer, "a[href*='/model/']:not([href*='/movie']):not([href*='/gallery/']):not(.page-button):not(.tab):has(.update-stream-card)", {
                  observe: true,
             ...
             case "www.hegre.com":
              (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, "#content-overlay .for-film .title > h1", {
                observe: true,
                urlSelector: _ => currentSite().substringBefore("?")
              });
              if (window.location.pathname.startsWith("/models/")) (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Performer, ".profile > h2", {
                observe: true,
                urlSelector: _ => currentSite().substringBefore("?")
              });
              (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Gallery, "#content-overlay .for-gallery .title > h1", {
                observe: true,
                urlSelector: _ => currentSite().substringBefore("?")
              });
             ...
             case "gayeroticvideoindex.com":
              if (window.location.pathname.startsWith("/performer/")) (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Performer, "[id='data'] h1", {
                ...
                urlSelector: currentSite
              }); else if (window.location.pathname.startsWith("/video/")) (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "[id='data'] h1", {
                urlSelector: currentSite
              });
              ...
              (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Group, "a[href*='video/']", {
                observe: true
              });
              break;
             ...
             case "pornolab.net":
              (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, "a.topictitle.tLink[href*='viewtopic.php']", {
                  ...
                  if (dashMatch) {
                    ...
                    if (/[()[\]{}]/.test(extracted)) {
                      ...
                      for (const part of parts) {
                        ...
                        if (hasFewerCommas || hasSameCommasButLonger) bestPart = part;
                      }
              ...
              (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Scene, "a.topictitle.tLink[href*='viewtopic.php']", {
                ...
                titleSelector: e => {
                  ...
                  const parenMatch = cleaned.match(/\(\s*([^)]+?)\s*\)/);
                  if (parenMatch) extracted = parenMatch[1].trim();
             ...
             case "stashdb.org":
              {
                ...
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Tag, ".MainContent > .NarrowPage h3 > span", {
                  ...stashBoxDefault,
                  displaySelector: e => window.location.pathname.startsWith("/tags/") ? e : null,
                  stashIdSelector: () => findId(currentSite())
                });
                (0, _check__WEBPACK_IMPORTED_MODULE_0__.z)(_dataTypes__WEBPACK_IMPORTED_MODULE_1__.We.Tag, `a[href^='/tags/']${exclude}, a[href^='https://${currentSite()}/tags/']${exclude}`, {
                  ...stashBoxDefault,
                  displaySelector: e => window.location.pathname === "/tags" ? e : null,
                  stashIdSelector: e => findId(closestUrl(e))
                });
                break;
              }
